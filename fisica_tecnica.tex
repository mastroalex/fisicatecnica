...
Sostanza che scambia calore e subisce una variazione di temperatura ha una corrispondente variazione del suo volume specifico: $d v=\left(\frac{\partial v}{\partial T}\right)_{p} d T+\left(\frac{\partial v}{\partial p}\right)_{T} d p$. Da cui la quantità misurabile, il coefficiente di dilatazione isobara:
\begin{equation}
	\left(\frac{\partial v}{\partial T}\right)_{p} \frac{1}{v}=\beta
\label{eq:coeff_dilatazione_isobara}
\end{equation}

E il coefficiente di compressione isoterma:
\begin{equation}
	\left(\frac{\partial v}{\partial p}\right)_{T}\left(-\frac{1}{v}\right)=\gamma
\end{equation}

Se le variazioni di volume specifico avvengono a sezione costante, possiamo dividere per la sezione e ottenere il coefficiente di dilatazione lineare:
\begin{equation}
...
Dalla definizione di entropia $ds=dq/T$ sostituiamo la definizione di calore \ref{eq:calore_sistemi_chiusi}. Poi possiamo farne il differenziale esatto $ds=ds(T,v)$ e otteniamo:
\begin{equation}
...
Dalla definizione di entropia $ds=dq/T$ sostituiamo la definizione di calore \ref{eq:calore_sistemi_aperti}. Poi possiamo farne il differenziale esatto $ds=ds(T,p)$ e otteniamo:
\begin{equation}
...
Inoltre $\frac{\left(\frac{\partial v}{\partial T}\right)_{p}}{\left(\frac{\partial p}{\partial T}\right)_{v}}=-\left(\frac{\partial v}{\partial p}\right)_{T}$ per Swartz. 
\newline
